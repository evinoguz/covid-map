...
test("Yükleme durumunda loader bileşenleri ekrana basılır.", () => {
  ...
  // Loader bileşeninin ekrana basıldı mı
...
it("Hata gelme durumunda error bileşeni ekrana basılır.", () => {
  ...
  // Hata metnini içeren bileşen ekrana basıldı mı
  screen.getByText(/404 content/i);
});

it("Veri gelirse ülke bilgisi ve kartlar ekrana basılır.", () => {
  // Veri gelirse store simüle et
  const store = mockStore({
    isLoading: false,
    error: null,
    data: exa_data,
